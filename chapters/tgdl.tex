...
Gli oggetti hanno due comportamenti principali:
...
Attualmente sono supportate tre tipologie: lista, table, stack.
...
\section{Giocatori}
I giocatori sono rappresentati da un numero intero da zero al numero di giocatori meno uno,
...
\begin{tabular}{|p{1.5cm}|c|p{5cm}|}
   ...
   \hline
   Passare al turno & \lstinline|turn.pass(player p, optional string phase)| & % TODO trovare un modo per spezzare 
